...
//     System.out.println(driver.getTitle());
     ...
     File folder = new File("C:\\Users\\shaya\\Desktop\\CMPE 187 Automation\\chinese");
...
//         if(i % 2 == 0)
//         {
             System.out.println("International food (Chinese) test case: " + counter);
             counter++;
//         }
//         System.out.println("International food (Chinese) test case: " + (i+1));
         if (foodList[i].isFile()) 
         {
            String foodImage = foodList[i].getName();
            String foodPath = "C:\\\\Users\\\\shaya\\\\Desktop\\\\CMPE 187 Automation\\\\chinese\\" + foodImage;
